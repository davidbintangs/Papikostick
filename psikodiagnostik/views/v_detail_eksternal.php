...
<div class="row">
    <div class="col-md-3">
        <div class="box box-info">
            ...
            <div class="box-body">
                <img class="profile-user-img img-responsive"  src="https://webip.indonesiapower.co.id:6090/api/foto/<?=$hasil->NIM?>"  alt="User profile picture">
                <h3 class="profile-username text-center"><b><?=$hasil->NAMA?></b></h3>
                <center><?=$hasil->UNIVERSITAS?></center>
                <ul class="list-group list-group-unbordered">

                    <li class="list-group-item">
                    <b>Jurusan</b> <a class="pull-right"><?=$hasil->JURUSAN?></a>
                    </li>
                    <li class="list-group-item">
                    <b>Email</b> <a class="pull-right"><?=$hasil->EMAIL?></a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="col-md-9">
        ...
        <div class="box box-primary box-solid">
            ...
            <div class="box box-primary no-padding">
                <div class="box-header with-border">
                    <h3 class="box-title">Nilai Potensi</h3>
                    <div class="box-tools pull-right">
                        <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                        </button>
                    </div>
...
<script>
    ...
    // render chart
        ...
        window.myRadar = new Chart(document.getElementById('potensi'), config_potensi);
